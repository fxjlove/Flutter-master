...
//Flutter页面布局 Paddiing Row Column Expanded组件 -- Flutter Expanded类似Web中的Flex布局     
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Flutter Expanded类似Web中的Flex布局  '),
        ),
        body: HomeContent(),
      ),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: <Widget>[
        ...
        Expanded(
          flex: 2,
          child: IconContainer(Icons.album,color: Colors.orange),
        ),
         Expanded(
          flex: 1,
